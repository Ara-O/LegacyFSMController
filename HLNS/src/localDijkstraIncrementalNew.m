function [costs,paths,event_path ] = ...
  localDijkstraIncrementalNew(init_cost,cur_state,ABS_event_path,ABS_pc,numRobots,states,events,tasks,regions,numRegions,start_loc,numTasks,abstracted,start_events_only,init_loc,robot_tasks)
...
%       prev_index=index;
      ...
      if(index == -1)
        ...
        botTable(end+1,:) = NaN;%botTable(prev_index,:);
  ...
  %      end
    ...
    %    J_costs(event_bot) = botTable(I,event_bot) + idle_cost;
        ...
        [transition_cost,~,new_X,new_Y] = ...
          calcTransitionCost(next_event,I,path{I},trans_mat,tasks,EEC,regions,numRegions,start_loc,...
