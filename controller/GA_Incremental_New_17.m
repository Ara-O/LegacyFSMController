...
%                 end
    ...
    if mod(change_value,5)==0 || aux_same_result>10
        mutation_rate=0.3;
        if (change_value/5)>=2 || aux_same_result > 20
            mutation_rate=0.4;
        end
    end
