function [path_state,path_event,final_region] = horizonPlanRegionsParallel3(cur_states,final_entry1,final_entry2,states_incr,num_fsm,event_list,events_incr,numRegions,numRobots,initialRegion,numTasks,desired_region1,desired_region2,rob1,rob2)
