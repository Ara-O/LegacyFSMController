...
% 
 num_rep=1;
            ...
            for i_num=1:num_rep
               ...
               cluster={{{'b03s'},{'b04s'},{'a01s'},{'c05s'},{'a02s'},{'c06s'}}};
               for i=1:numRobots
               ...
               [path,path_events,cost]= createChromosomeGreedy(cluster,states_incr,num_fsm,initial_state_incr,event_list,events_incr,numRobots,numTasks,tasksRegions,initialRegions,numRegions,start_loc,tasks,regions,states,events);
