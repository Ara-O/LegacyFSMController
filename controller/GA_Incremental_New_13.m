...
for i=1:100
    path_abs{i}={{'b01s'},{'a05s'},{'b02s'},{'a06s'},{'b03s'},{'b04s'}};
end
...
%                 offspring_event{ind}=parent_1_events;
                  [offspring{ind},offspring_event{ind}] = newCrossover(parent_1_events,states_incr,num_fsm,initial_state_incr,event_list,events_incr);
                  [offspring{ind},offspring_event{ind}] = newCrossover(offspring_event{ind},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
                  [offspring{ind},offspring_event{ind}] = newCrossover(offspring_event{ind},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
                  ind=ind+1;
            %else
                %                 offspring{ind}=parent_2;
                %                 offspring_event{ind}=parent_2_events;
                [offspring{ind},offspring_event{ind}] = newCrossover(parent_2_events,states_incr,num_fsm,initial_state_incr,event_list,events_incr);
                [offspring{ind},offspring_event{ind}] = newCrossover(offspring_event{ind},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
                [offspring{ind},offspring_event{ind}] = newCrossover(offspring_event{ind},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
                ind=ind+1;
            %end
