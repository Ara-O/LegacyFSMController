function [costs,path_state,path_events] = ...
  robotDijkstraGreedyNew2Hiear(abs_path,cur_state,numRobots,states,events,tasks,regions,numRegions,start_loc,numTasks,ABSTRACTED,start_events_only,robot_tasks)
