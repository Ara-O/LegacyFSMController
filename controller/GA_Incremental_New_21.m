...
%             if (change_value/12)<1 && aux_same_result<10
    ...
    if aux_same_result>30
        for i=1:length(mutation_idx)
            %ind=ind+1;
            [offspring{ind},offspring_event{ind}] = changeEntryEvents(offspring{mutation_idx(i)},offspring_event{mutation_idx(i)},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
            [offspring{ind},offspring_event{ind}] = changeEntryEvents(offspring{ind},offspring_event{ind},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
            [offspring{ind},offspring_event{ind}] = changeEntryEvents(offspring{ind},offspring_event{ind},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
            ind=ind+1;
