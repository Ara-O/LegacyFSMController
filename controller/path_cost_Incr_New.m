function [cost,cost_trans,cost_extra] = path_cost_Incr_New(path_events,start_loc,states,tasks,regions,numRegions,numTasks,abstracted,start_events_only,robot_tasks,numRobots)
...
%         act_state=path_gen{1,j};
        ...
        [transition_cost,~,new_X,new_Y] = ...
            calcTransitionCostGAAA(next_event,path_events,j,states,tasks,0,regions,numRegions,start_loc,...
