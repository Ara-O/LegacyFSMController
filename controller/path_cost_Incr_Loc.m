function [cost,cost_trans,cost_extra,robotLocation] = path_cost_Incr_Loc(path_gen,path_events,start_loc,states,tasks,regions,numRegions,numTasks,abstracted,start_events_only,robot_tasks,numRobots)
