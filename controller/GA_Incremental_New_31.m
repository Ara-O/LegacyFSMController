...
tic;
while j<=num_paths
    [path_gen{j},path_events{j}]=createChromosomeRegions3RenewSingle(path_abs(j),states_incr,num_fsm,initial_state_incr,event_list,events_incr,numRobots,numTasks,tasksRegions,initialRegions,numRegions);
