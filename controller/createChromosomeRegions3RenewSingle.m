function [path,path_events]= createChromosomeRegions3RenewSingle(path_abs,states_incr,num_fsm,initial_state_incr,event_list,events_incr,numRobots,numTasks,taskRegions,initialRegions,numRegions)
i=1;
state_i=1;
event_i=1;
desired_region1=0;
...
elseif i-1-aux_finish==2
    ...
    [path_state_middle,path_event_middle,initialRegions,aux_final1,aux_final2] = horizonPlanRegionsParallel3RenewSingle(cur_states,final_event1,final_event2,states_incr,num_fsm,event_list,events_incr,numRegions,numRobots,initialRegions,numTasks,des_region1,des_region2,robot1,robot2);
    indPlan=randi([1 length(path_event_middle)]);
    path_events={path_events{1:end},path_event_middle{indPlan}{1:end}};
    path={path{1:end-1},path_state_middle{indPlan}{1:end}};
    state_i=length(path)+1;
    ...
    [path_state_middle,path_event_middle,initialRegions,aux_final1,aux_final2,aux_final3] = horizonPlanRegionsParallel3RobotsRenewSingle(cur_states,final_event1,final_event2,final_event3,states_incr,num_fsm,event_list,events_incr,numRegions,numRobots,initialRegions,numTasks,des_region1,des_region2,des_region3,robot1,robot2,robot3);
    indPlan=randi([1 length(path_event_middle)]);
    path_events={path_events{1:end},path_event_middle{indPlan}{1:end}};
    path={path{1:end-1},path_state_middle{indPlan}{1:end}};
    state_i=length(path)+1;
