...
runningScenario=12;
  ...
  run(['../FSMs/' ABSfoldName '/fsmdata_Full.m'])       %Import FSM data from FSM GUI
  ...
  %for i_t=1:length(table_minitab)
     %i_t=1;
            ...
            %stop_cond_1=table_minitab(i_t,3);
             ...
             population_size_1=500;%table_minitab(i_t,1);
