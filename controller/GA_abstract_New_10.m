function [plan,plan_state,plan_cost,num_spoint,initial_plan,num_of_changes,idx_change,trac_plan_cost] = GA_abstract_New_10(population_size,max_rep,mutation_rate,stop_cond,states,start_loc,numTasks,numRobots,numRegions,tasks,regions,robot_tasks)
num_of_changes=0;
abstracted = true;
...
for j=1:population_size
    ...
    n=1;
    while aux
        path_gen{j}(i,1)=act_state; %save at the state being analyzed
