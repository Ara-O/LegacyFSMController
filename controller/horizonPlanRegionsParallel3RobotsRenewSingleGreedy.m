function [path_state,path_event,final_region,aux_final1,aux_final2,aux_final3,costTable,robotLocation] = horizonPlanRegionsParallel3RobotsRenewSingleGreedy(path_event,path_state,costTable,robotLocation,cur_states,final_entry1,final_entry2,final_entry3,states_incr,num_fsm,event_list,events_incr,numRegions,numRobots,initialRegion,numTasks,desired_region1,desired_region2,desired_region3,rob1,rob2,rob3)
abstracted = false;
