function [path_state,path_event,final_region] = horizonPlanRegionsParallel3Entry(cur_states,final_entry1,final_entry2,states_incr,num_fsm,event_list,events_incr,numRegions,numRobots,initialRegion,numTasks,desired_region1,desired_region2,rob1,rob2)
...
while aux_final1==0 || aux_final2==0
    ...
    robot_entry=findEntryEventsRobots(possible_transitions,robots);
