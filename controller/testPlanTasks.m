function [finalPlan, PlanCost] = testPlanTasks(desired_tasks,cur_state,states,event_list,num_fsms,numRobots,start_loc,tasks,regions,numRegions,numTasks,abstracted,start_events_only,robotTask,events)
