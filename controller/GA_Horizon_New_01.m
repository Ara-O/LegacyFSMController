...
%Plan
function [all_plan,plan,plan_state,plan_cost,num_spoint,initial_plan,num_of_changes,idx_change,trac_plan_cost,num_rep,t_dur,t_pop] = GA_Horizon_New_01(path_abs,num_paths,max_rep,mutation_rate,stop_cond,states,start_loc,numTasks,numRobots,numRegions,tasks,regions,robot_tasks,states_incr,events_incr,initial_state_incr,initial_state,events)
num_of_changes=0;
abstracted = false;
...
% num_paths=10;
while j<=num_paths
    [path_gen{j},path_events{j}]=createChromosomeRegionsHorizon(path_abs,states_incr,num_fsm,initial_state_incr,event_list,events_incr,numRobots,numTasks,tasksRegions,initialRegions,numRegions);
...
%             total_cost_parents{num_rep}(ind)=cost_parent_1;
            ...
            ind=ind+1;
            [offspring{ind},offspring_event{ind}] = newCrossover(3,offspring_event{ind-1},states_incr,num_fsm,initial_state_incr,event_list,events_incr,initialRegions);
            %                     ind=ind+1;
            %                     [offspring{ind},offspring_event{ind}] = newCrossover(1,offspring_event{ind-1},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
            %                 end
...
%             total_cost_parents{num_rep}(ind)=cost_parent_1;
            ...
            [offspring{ind},offspring_event{ind}] = newCrossover(3,offspring_event{ind-1},states_incr,num_fsm,initial_state_incr,event_list,events_incr,initialRegions);
            ind=ind+1;
            [offspring{ind},offspring_event{ind}] = newCrossover(1,offspring_event{ind-2},states_incr,num_fsm,initial_state_incr,event_list,events_incr,initialRegions);
            %             end
            ind=ind+1;
            ...
            %             if change_value >=1
            ind=ind+1;
            [offspring{ind},offspring_event{ind}] = newCrossover(1,offspring_event{ind-1},states_incr,num_fsm,initial_state_incr,event_list,events_incr,initialRegions);
            ind=ind+1;
            [offspring{ind},offspring_event{ind}] = newCrossover(3,offspring_event{ind-2},states_incr,num_fsm,initial_state_incr,event_list,events_incr,initialRegions);
            ind=ind+1;
            %                 [offspring{ind},offspring_event{ind}] = newCrossover(1,offspring_event{ind-1},states_incr,num_fsm,initial_state_incr,event_list,events_incr);
            %             end
...
%         end
    ...
    mutation_idx=mutation_idx_total(1:mutation_idx_max);
        ...
        for i=1:length(mutation_idx)
            [offspring{ind},offspring_event{ind}] = newCrossover(1,offspring_event{mutation_idx(i)},states_incr,num_fsm,initial_state_incr,event_list,events_incr,initialRegions);
            ind=ind+1;
