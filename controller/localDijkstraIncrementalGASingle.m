function [costs,paths,event_path,robotLocation ] = ...
  localDijkstraIncrementalGASingle(possible_transitions,robots_costs,cur_state,numRobots,states,events,tasks,regions,numRegions,start_loc,numTasks,abstracted,start_events_only,init_loc)
...
for k = 1:1  
  ...
  botTable = robots_costs;%NaN(n,numRobots);  % Individual robot costs matrix
  %I = cur_state(k);
  I = 1;
  ...
  %      end
    ...
    %    J_costs(event_bot) = botTable(I,event_bot) + idle_cost;
        ...
        [transition_cost,~,new_X,new_Y] = ...
          ...
          numTasks,abstracted,start_events_only,robotLocation{I,event_bot},robotTask,1);
