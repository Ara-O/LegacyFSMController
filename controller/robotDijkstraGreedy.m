function [costs,paths,event_path,num_eval] = ...
  robotDijkstraGreedy(cur_state,numRobots,states,events,tasks,regions,numRegions,start_loc,numTasks,ABSTRACTED,start_events_only,robot_tasks)
...
%        end
     ...
     %                              + transition_cost;
        ...
        J_costs(event_bot) =transition_cost; %J_costs(event_bot) + transition_cost;
