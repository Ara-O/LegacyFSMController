function [transition_cost,trans_event,new_X,new_Y] ...
          = calcTransitionCostGAA(next_event,cur_state,event_path,num_state,state_path,states,tasks,EEC,regions,numRegions,start_loc,...
...
%   end
    ...
    robX =  bot_location(1);%start_loc(taskRobot,1);
    robY = bot_location(2);%start_loc(taskRobot,2);
