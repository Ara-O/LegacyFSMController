function [path_state,path_event,final_region] = horizonPlanRegions(cur_states,final_entry1,states_incr,num_fsm,event_list,events_incr,numRegions,numRobots,initialRegion,numTasks,desired_region1)
