function [costs,path_state,path_events] = ...
  robotDijkstraGreedyNew(cur_state,numRobots,states,events,tasks,regions,numRegions,start_loc,numTasks,ABSTRACTED,start_events_only,robot_tasks)
    ...
    if ~isempty(start_transitions)
        ...
        for kk = 1:num_transitions(1) % iterate through the number of transitions
            ...
            [transition_cost,~,new_X,new_Y] = ...
                ...
                numTasks,0,1,robotLocation{j,event_bot},robot_tasks,1);
...
%         costs=costs+costs_min;
    ...
    elseif aux_finish
        ...
        while aux_region && index_aux <=length(index_sort)
            ...
            if region(event_bot,actualRegion)<1
                aux_region=0;
