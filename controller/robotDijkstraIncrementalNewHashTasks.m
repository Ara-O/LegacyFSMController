function [costs,paths,event_path,num_eval] = ...
  robotDijkstraIncrementalNewHashTasks(cur_state,numRobots,states,events,tasks,regions,numRegions,start_loc,numTasks,ABSTRACTED,start_events_only,robot_tasks)
...
for k = 1:1  
  ...
  while end_unsettled %any(~isSettled(end_state))
    ...
    [possible_transitions] = findOddStartEventsOnly(possible_transitions);  
