...
% start_loc = {x, y}
start_loc = { -1.9766,  -1.1778;
    0.57524,  2.2153 };

% tasks = {'name', x1, y1, 'function', 'from_task_name'}
tasks = { 'tsk01',  -3,  2,  'D',  'start';
    'tsk02',  2,  -1,  'D',  'tsk1';
    'tsk03',  -1,  2,  'D',  'start';
    'tsk04',  2,  1,  'D',  'tsk3';
    'tsk05',  -1,  -1,  'D',  'start';
...
regions = { 'reg09',  -3,  -3,  0,  0;
    ...
    'reg11',  0,  0,  3,  3;
    'reg12',  0,  -3,  3,  0;
    'regtsk01',  -3.25,  1.75,  -2.75,  2.25;
    'regtsk02',  1.75,  -1.25,  2.25,  -0.75;
    'regtsk03',  -1.25,  1.75,  -0.75,  2.25;
    'regtsk04',  1.75,  0.75,  2.25,  1.25;
    'regtsk05',  -1.25,  -1.25,  -0.75,  -0.75;
    'regtsk06',  -2.25,  0.75,  -1.75,  1.25;
    'regtsk07',  1.75,  -2.25,  2.25,  -1.75;
    'regtsk08',  1.75,  1.75,  2.25,  2.25 };
